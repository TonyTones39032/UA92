...
<button class="go-back-btn">
    ...
    <form name="myForm" action="addparent.php"s method="post" onsubmit="return validateForm()">
     
        <input type="text" id="ParentID" name="ParentID" placeholder="ParentID" >
        <br><br>
        ...
        <br><br>
        <input type="number" id="number" name="PhoneNumber" placeholder="Phone Number">
        <br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `week 4`.`parent` (pID, pName, `email`, number) VALUES ('$pID', '$pName', '$email', '$number')";
