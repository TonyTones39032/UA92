...
<div class="navbar">
    ...
    <form method="post" action="updateparent.php">
        ...
        <input type="text" name="pid" placeholder="ParentID"><br><br>

    
        <input type="text" name="pname" placeholder="ParentName"><br><br>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE parent SET pName='$pName', email='$email', number = '$number'  WHERE pID='$pID'";
