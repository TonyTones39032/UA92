...
<script>
        function validateForm() {
            let cid = document.forms["myForm"]["cid"].value;
...
<div class="navbar">
    ...
    <form name="myForm" method="post" action="updateclass.php" onsubmit="return validateForm()">
        ...
        <input type="text" name="cid" placeholder="ClassID"><br><br>

    
        <input type="text" name="name" placeholder="ClassName"><br><br>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE class SET name='$Name', Field='$Field' WHERE cID='$cID'";
