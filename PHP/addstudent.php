...
<button class="go-back-btn">
    ...
    <form name="myForm" action="addstudent.php"s method="post" onsubmit="return validateForm()">
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `week 4`.`student` (sID, sName, `email`, `number`) VALUES ('$sID', '$sName', '$email', '$number')";
