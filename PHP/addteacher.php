...
function validateForm() {
    let x = document.forms["myForm"]["TeacherID"].value;
...
<button class="go-back-btn">
    ...
    <form name="myForm" action="addteacher.php"s method="post" onsubmit="return validateForm()">
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `week 4`.`teacher` (tID, tName, `email`, number) VALUES ('$tID', '$tName', '$email', '$number')";
